...
import { companySecrets, companySecretVersions } from "@crixlyai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@crixlyai/shared";
import { envBindingSchema } from "@crixlyai/shared";
