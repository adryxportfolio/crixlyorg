 ...
 */
import type { CompanyPortabilityManifest } from "@crixlyai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Crixly](https://crixly.org)");
  lines.push("");
