...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@crixlyai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: CrixlyPluginManifestV1, pluginDbId?: string): void;
