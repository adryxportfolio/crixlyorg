/**
 * PluginEventBus — typed in-process event bus for the Crixly plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@crixlyai/shared";
import type { PluginEvent, EventFilter } from "@crixlyai/plugin-sdk";
