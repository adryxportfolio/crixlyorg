...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Crixly state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".crixly/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/crixly",
      ),
    ).toBe(false);
