...
import { models as codexFallbackModels } from "@crixlyai/adapter-codex-local";
import { models as cursorFallbackModels } from "@crixlyai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@crixlyai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.CRIXLY_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.CRIXLY_OPENCODE_COMMAND = "__crixly_missing_opencode_command__";
