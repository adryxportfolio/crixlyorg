...
Manage companies within your Crixly instance.
...
Company logo uploads use the normal Crixly attachment size limit.
...
| `logoUrl` | string | Optional Crixly asset content path for the stored logo image |
