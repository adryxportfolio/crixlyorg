...
- Running a Python script that calls the Crixly API
...
1. Crixly spawns the configured command as a child process
2. Standard Crixly environment variables are injected (`CRIXLY_AGENT_ID`, `CRIXLY_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Crixly API and perform work.
