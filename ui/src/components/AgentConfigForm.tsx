...
import { AGENT_ADAPTER_TYPES } from "@crixlyai/shared";
import type {
  Agent,
...
// Canonical type lives in @crixlyai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@crixlyai/adapter-utils";
import type { CreateConfigValues } from "@crixlyai/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        CRIXLY_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
