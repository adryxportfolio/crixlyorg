...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative crixly-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("crixly-mdxeditor", !bordered && "crixly-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "crixly-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
