...
import type { ActivityEvent } from "@crixlyai/shared";
import type { Agent, IssueAttachment } from "@crixlyai/shared";
...
export function IssueDetail() {
  ...
  const attachmentUploadButton = (
    <>
      ...
      >
        <Crixly className="h-3.5 w-3.5 mr-1.5" />
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`crixly:issue-comment-draft:${issue.id}`}
            enableReassign
