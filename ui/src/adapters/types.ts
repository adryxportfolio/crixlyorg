...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@crixlyai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@crixlyai/adapter-utils").TranscriptEntry[];
