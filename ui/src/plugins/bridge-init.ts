 ...
 *
 * This is placed on `globalThis.__crixlyPluginBridge__` and consumed by
...
declare global {
  ...
  var __crixlyPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__crixlyPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__crixlyPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
