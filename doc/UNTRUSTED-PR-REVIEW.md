...
This is intentionally separate from the normal Crixly dev image.
...
```sh
review-checkout-pr crixlyai/crixly 432
cd /work/checkouts/crixlyai-crixly/pr-432
```
...
## Preview the Crixly app from the PR
...
- Crixly's embedded PostgreSQL and local storage stay inside the container home volume via `CRIXLY_HOME=/home/reviewer/.crixly-review`.
