...
This document covers the GitHub and npm setup required for the current Crixly release model:
...
Do this for every public package that Crixly publishes.
...
3. add a trusted publisher for the GitHub repository `crixlyai/crixly`
...
2. revoke any personal automation token that used to publish Crixly
