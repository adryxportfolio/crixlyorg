...
Low-level reference for how Crixly packages are prepared and published to npm.
...
Crixly no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `crixlyai`, imports code from workspace packages such as:
