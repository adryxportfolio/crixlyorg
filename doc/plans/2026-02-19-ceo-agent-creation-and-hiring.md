...
- installed adapter list for this Crixly instance
...
## 8. New Skill: `crixly-create-agent`

Create new skill directory:

- `skills/crixly-create-agent/SKILL.md`
...
Also update `skills/crixly/SKILL.md` to reference this skill for hiring workflows.
...
- `crixly-create-agent` skill + docs updates
