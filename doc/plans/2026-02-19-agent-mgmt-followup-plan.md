...
- `skills/crixly/SKILL.md` and `skills/crixly/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/crixly-create-agent/SKILL.md`
