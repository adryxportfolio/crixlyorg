# Crixly API Reference

Detailed reference for the Crixly control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Crixly Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "crixly-mobile",
    "cwd": "/Users/me/crixly-mobile",
    "repoUrl": "https://github.com/acme/crixly-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `crixly-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
