...
Eval framework for testing Crixly agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Crixly heartbeat skill:
