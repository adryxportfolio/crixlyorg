...
Use when:
- You want Crixly to run Pi (the AI coding agent) locally as the agent runtime
...
- Crixly requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/crixlys/ and resumed with --session.
