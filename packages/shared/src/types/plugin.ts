...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within CrixlyPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Crixly host.
 *
...
export interface CrixlyPluginManifestV1 {
   ...
   */
  minimumCrixlyVersion?: PluginMinimumHostVersion;
