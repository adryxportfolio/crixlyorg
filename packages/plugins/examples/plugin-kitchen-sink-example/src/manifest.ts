...
const manifest: CrixlyPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Crixly plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Crixly",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Crixly domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
