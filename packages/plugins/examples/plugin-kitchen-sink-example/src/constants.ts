import type { PluginLauncherRegistration } from "@crixlyai/plugin-sdk";

export const PLUGIN_ID = "crixly-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".crixly-kitchen-sink-demo.txt",
} as const;
