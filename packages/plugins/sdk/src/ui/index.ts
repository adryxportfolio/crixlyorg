/**
 * `@crixlyai/plugin-sdk/ui` — Crixly plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@crixlyai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@crixlyai/plugin-sdk/ui";
 *
