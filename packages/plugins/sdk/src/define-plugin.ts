/**
 * `definePlugin` — the top-level helper for authoring a Crixly plugin.
 *
...
// ---------------------------------------------------------------------------
// CrixlyPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `CrixlyPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@crixlyai/plugin-sdk";
