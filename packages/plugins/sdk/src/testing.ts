...
function requireCapability(manifest: CrixlyPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Crixly server runtime.
 */
