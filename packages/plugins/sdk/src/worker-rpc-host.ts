...
import type { CrixlyPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@crixlyai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: CrixlyPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@crixlyai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
