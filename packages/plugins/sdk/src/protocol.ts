 ...
 * channel.
 *
 * The Crixly plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@crixlyai/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Crixly messages.
 */
...
/**
 * Crixly plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Crixly instance. */
    instanceId: string;
    /** Semver version of the running Crixly host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
