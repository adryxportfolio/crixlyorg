...
import type { PluginCategory, PluginStatus, CrixlyPluginManifestV1 } from "@crixlyai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<CrixlyPluginManifestV1>().notNull(),
